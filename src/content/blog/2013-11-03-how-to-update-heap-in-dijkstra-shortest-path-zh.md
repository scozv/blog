---
title: "Dijkstra最短距离算法优化：动态最小堆结构实现"
description: '为了将Dijkstra最短路径算法的时间复杂度从 $O(nm)$ 降低到 $O(n \ln m)$ ， 我们可以使用 __heap__ 。不过迭代中的每一次更新heap的过程，我们需要一些技巧来保持heap的有序性。 本文就会指出该技巧，并且解释我在算法代码中的一些[变动] [3]。 本文大部分的解释需要阅读英文版本。'
category: algo
tags:
  - algorithm
  - graph
  ...
  - heap
lang: zh
slug: heap-update-in-dijkstra-for-nlogn-zh
pubDatetime: 2013-11-03T00:00:00.000Z
---
